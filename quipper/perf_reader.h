...
class PerfReader {
 ...
 private:
  ...
  // After PERF-4.13, google specific piped mode events are not generated by
  // perf. Instead, they are populated under PERF_RECORD_HEADER_FEATURE. This
  // flag is used to identify whether or not the current perf.data file contains
  // google specific piped mode events.
  bool containsGoogleSpecificPipedModeEvents;
