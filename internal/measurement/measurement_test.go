...
func TestScale(t *testing.T) {
	for _, tc := range []struct {
		...
		{7, "teragcus", "microGCU", 7e18, "μ·GCU"},
		{1, "petaGCU", "nanogcus", 1e24, "n·GCU"},
		{8e10, "n*GCU", "P*GCUS", 8e-14, "P·GCU"},
		{1.5e10, "u·GCU", "T·GCU", 1.5e-8, "T·GCU"},
		{3e6, "m·GCU", "G*GCU", 3e-6, "G·GCU"},
		{1000, "k*GCU", "M·GCU", 1, "M·GCU"},
		{2000, "GCU", "k*GCU", 2, "k·GCU"},
		{7, "M·GCU", "GCU", 7e6, "GCU"},
		{5, "G·GCUs", "m*GCU", 5e12, "m·GCU"},
		{7, "T*GCUs", "μ·GCU", 7e18, "μ·GCU"},
		{1, "P*GCU", "n*GCUs", 1e24, "n·GCU"},
		{100, "NanoGCU", "auto", 100, "n·GCU"},
		{5000, "nanogcu", "auto", 5, "μ·GCU"},
