...
func browsers() []string {
	...
	default:
		// sensible-browser prioritized over xdg-open, so browser() command can
		// be used on linux to open the .svg file generated by the -web command
		// (the .svg file includes embedded javascript so is best viewed in a
		// browser).
