...
pprof can read profiles from a file or directly from a URL over http, https, or 
https+insecure. Its native format is a gzipped profile.proto file, but it can
