...
func AddCommand(cmd string, format int, post func(input io.Reader, output io.Writer, ui UI) error, desc, usage string) {
	internaldriver.AddCommand(cmd, format, post, desc, usage)
}
